...
Tuttavia, UDP non ha controllo di congestione, quindi può potenzialmente consumare più banda delle connessioni TCP, portando a una situazione di \textbf{unfairness}.
